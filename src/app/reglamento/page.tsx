...
Ningún jugador podrá estar incluido en forma simultánea en la lista de buena fe de dos o más equipos distintos dentro de un mismo torneo. No obstante, un jugador que participa en una categoría inferior podrá jugar en otra inmediata superior -dentro del mismo calendario del torneo-, solo para completar la formación de un equipo que represente al mismo barrio, club o country al que pertenece su equipo original. Nunca el reemplazo podrá realizarse en sentido inverso, es decir de la categoría más alta a la más baja.
 
A los fines de su registración sistémica y posterior carga de resultados, los capitanes que hagan uso de la opción de contar con “suplentes naturales” provenientes de una categoría más baja -que se encuentren dentro de la nómina inscripta para su equipo original-, deberán solicitar a la Organización la habilitación individual de estos jugadores para ser agregados dentro la lista de buena fe del equipo participante en la categoría más alta. El número total que resulte de sumar a los originalmente registrados en esta lista más los suplentes que se habiliten a solicitud del capitán, no podrá exceder en ningún caso, la cantidad máxima de jugadores que el sistema permita inscribir dentro de la lista de buena fe de cada torneo.
 
Frente al supuesto de un jugador que participa como “suplente natural” en una categoría superior y obtiene en ella una victoria (tanto sea en singles como en dobles), la Organización tiene la potestad de recategorizarlo de oficio, luego de efectuar un seguimiento sobre sus resultados y rendimiento a fin de determinar si su real nivel de juego es acorde a la categoría en la que fue originalmente inscripto. Esta potestad, resulta extensible respecto de cualquier jugador de la Liga, incluso en aquellos casos que no hayan sido utilizados como “suplentes naturales” en equipos de categoría superior.
 
El seguimiento mencionado en el párrafo anterior, implicará que configurada la situación que amerite su ejercicio, si el jugador en sus dos partidos siguientes obtiene victorias en la categoría más alta, quedará automáticamente inhabilitado para volver a jugar en una categoría inferior. Caso contrario, dicha inhabilitación resultará igualmente aplicable cuando el diferencial entre las victorias en la categoría más alta y las derrotas en la categoría más baja -en cualesquiera de sus partidos siguientes- arroje un número mayor o igual a dos (2).
...
o Como singlista o como doblistas pueden presentarse cualquiera de los cinco jugadores listados para participar de una serie, en la medida que cumplan con el requisito de partidos mínimos jugados previamente, en caso de que ello corresponda a la instancia que se está disputando.
o En caso de incluirse a un jugador +30 pero menor de 35, su capitán podrá ubicarlo en cualquiera de los tres partidos correspondientes a la serie en disputa (Single, Doble 1 o Doble 2), previa notificación de su decisión al capitán del equipo rival. Solo podrá hacerse uso de esta excepción en uno y solo uno de los tres puntos en juego. Esto implica que como máximo, solo dos jugadores menores de 35 podrán ser de la partida dentro de la formación de su equipo para una serie en particular.
o Los restantes jugadores podrán ubicarse en cualquiera de las posiciones no especificadas.
o Las edades a computar a los fines de verificar los requisitos previos, serán las que se cumplan dentro del año calendario en el que se está desarrollando el torneo.
 
Los jugadores de los equipos que se presenten para jugar la Final y la Semifinal de cada categoría o copa, al igual que quienes participen de las series de la segunda fase (tanto en Copa Gaudio como en Copa Coria) deberán haber jugado como mínimo en una fecha durante la primera etapa del torneo (“round robin” o “todos contra todos”). Además, en el caso de las series de finales y semifinales, las listas con la integración de su formación para esos cruces deberán ser presentadas a la Organización con 24 horas de antelación al inicio de la serie. Los capitanes de esos equipos tendrán derecho a requerir la formación declarada por sus rivales, por lo que -encontrándose anoticiados de la misma- una vez iniciado el primero de los partidos perderán toda posibilidad de reclamo o impugnación.
 
Similar procedimiento deberá cumplirse al inicio de las restantes series que se jueguen en las fases de “round robin” y en las de “Eliminatorias en zonas” anteriores a las semifinales y finales de cada copa: al momento de presentarse en cancha -y previo al inicio de los partidos- los capitanes de cada equipo deberán intercambiar una planilla con el detalle de los jugadores seleccionados para integrar sus formaciones, con las formalidades que la Organización establezca.
...
En el momento del sorteo se establecerá para cada equipo la cantidad de partidos que jugará como local y visitante, los que en tal sentido tenderán a ser, en la medida de lo posible, por partes iguales.`,
    },
...
a) Explicar a sus jugadores los principios fundacionales y espíritu del Torneo, así como las reglas de juego y de participación
b) Elaborar las listas de buena fe y cargarlas en la web
c) Inscribir el equipo en la categoría que corresponda
d) Abonar la inscripción correspondiente
e) Informar a la Organización el horario en el que se programarán los partidos de su equipo a jugarse en condición de local
f) Verificar que se cumplan todas las condiciones reglamentarias tanto de local como de visitante
g) Cumplir y hacer cumplir todos los protocolos previos al encuentro
h) Cargar los resultados de cada serie (Equipo ganador) y confirmarlos (Equipo perdedor) como máximo hasta 3 días luego de realizado el encuentro, a fin de no complicar el buen desarrollo del torneo
i) Ambos capitanes deberán enviar fotos del juego durante la serie, así como de ambos equipos reunidos al final o comienzo del partido, para ser publicados en las redes sociales de la liga.
...
Cuando un Barrio o Club tenga dos o más equipos en la misma división, éstos se considerarán como Equipos distintos. Los jugadores de estos equipos no podrán jugar en ningún otro de la misma división a la que pertenezcan, ni siquiera en los anotados bajo la misma denominación de Barrio o Club.
...
`,
    ...
    {
      title: "1ra Fase “Round Robin” general por grupos",
      text: `El Torneo se conforma con dos (2) grupos/zonas (“A” y “B”) de 9 y 10 equipos -respectivamente- en cada uno, lo que totaliza en conjunto diecinueve (19) inscriptos para la presente edición.
 
Se juega una primera fase con formato de “Round Robin” o “todos contra todos” dentro de cada grupo, totalizando ocho (8) encuentros para cada equipo del grupo “A”, y nueve (9) encuentros para cada equipo del grupo “B”.
 
Los primeros 4 clasificados de esta fase en el grupo “A”, junto con los 5 primeros del grupo “B”, conformarán una nueva zona de ganadores, llamada Copa Gaudio Segunda (9 equipos). A esta zona se le agregará el último de la tabla general correspondiente a los equipos de la categoría inmediatamente superior (Intermedia), totalizando 10 equipos en competencia por esta Copa.
 
Por su parte, los ubicados en las restantes posiciones de la clasificación en los dos grupos antes mencionados formarán la zona perdedores, o Copa Coria Segunda (otros 10 equipos).`,
    },

    {
      title: "2da Fase: Eliminatorias en zonas",
      text: `Definidos los ingresos a las Copas Gaudio Segunda o Coria Segunda se competirá en una nueva fase, esta vez de eliminación del torneo para algunos equipos, con el fin de definir a los semifinalistas de cada zona.
 
Los diez (10) equipos de la Copa Gaudio Segunda jugarán tres (3) partidos contra rivales de esa misma zona a definirse por sorteo, igual metodología a la que se aplicará a fin de establecer las localías, salvo el caso de reiterarse cruces de la fase previa, en los que se invertirá la condición de local.
 
Asimismo, los otros diez (10) equipos de la Copa Coria Segunda jugarán tres (3) partidos contra rivales de esa misma zona, definidos del mismo modo. Luego de estos 3 partidos, los 4 equipos mejor clasificados en cada zona (o Copa) pasarán a la fase final del torneo, de eliminación directa (Play off).
 
Con este esquema, se garantiza la participación de todos los equipos con un mínimo de entre 11 y 12 encuentros jugados, y hasta un máximo de 14 fechas generales a jugarse, manteniendo vivas para todos, las aspiraciones por acceder a las instancias de premiación, prácticamente hasta el final de la competencia.`,
    },
    {
      title: "3ra Fase: Semifinales y Finales",
      text: `Los cuatro (4) equipos mejor clasificados de cada Copa jugarán las semifinales.
 
Los cruces y las localías se determinarán en función de los resultados obtenidos en la 2da Fase (El Primero -de local- versus el Cuarto -como visitante-, y el Segundo -de local- versus el Tercero -como visitante-).
 
Los ganadores de esos cruces jugarán las finales de la Copa Gaudio Segunda y de la Copa Coria Segunda en cancha neutral, a efectos de definir al campeón y subcampeón de cada una.
 
Las posiciones finales en una y otra copa determinarán la distribución de los equipos que participen en la edición del Torneo prevista para el primer semestre del próximo año, con el ascenso a la categoría INTERMEDIA +35 de los dos equipos finalistas de la Copa Gaudio Segunda.`,
    },
    {
    ...
    {
      title: "1ra Fase: “Round Robin” general por grupos",
      text: `El Torneo se conforma con dos (2) grupos/zonas (“A” y “B”) de 9 y 8 equipos -respectivamente- en cada uno, lo que totaliza en conjunto diecinueve (17) inscriptos para la presente edición.
 
Se juega una primera fase con formato de “Round Robin” o “todos contra todos” dentro de cada grupo, totalizando ocho (8) encuentros para cada equipo del grupo “A”, y siete (7) encuentros para cada equipo del grupo “B”.
 
Los primeros 4 clasificados de esta fase en el grupo “A”, junto con los 4 primeros del grupo “B”, conformarán una nueva zona de ganadores, llamada Copa Gaudio
Intermedia (8 equipos).
 
Asimismo, entre los otros nueve (9) equipos restantes se organizará una “subtabla” general ordenada de mayor a menor según el porcentaje de efectividad de cada uno de ellos respecto de las series ganadas sobre las jugadas. El equipo con porcentaje más bajo, pasará a jugar la Copa Gaudio Segunda. En caso de igualdad en el último lugar de la “subtabla” general, se definirá el pase a la categoría inmediata inferior repitiendo el análisis de efectividad porcentual para las restantes variables que contempla el punto 3 del Reglamento General (partidos ganados, sets ganados, games ganados, etc.)
 
De esta manera, los ubicados en las restantes posiciones de la clasificación en los dos grupos antes mencionados formarán la zona perdedores, o Copa Coria Intermedia (otros 8 equipos).
`,
    },
    {
      title: "2da Fase: Eliminatorias en zonas",
...
Los ganadores de esos cruces jugarán las finales de la Copa Gaudio Intermedia y de la Copa Coria Intermedia en cancha neutral, a efectos de definir al campeón y subcampeón de cada una.
 
Las posiciones finales en una y otra copa determinarán la distribución de los equipos que participen en la edición del Torneo prevista para el primer semestre del próximo año, con el descenso a la categoría SEGUNDA +35 de los dos equipos con más baja performance entre los que participen de la Copa Coria Intermedia.`,
    },
  ];
